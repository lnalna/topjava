...
public abstract class JdbcMealRepositoryImpl<T> implements MealRepository {
    ...
    protected abstract T getLocalDateTime(LocalDateTime localDateTime);
    ...
    public static class JdbcMealRepositoryPostgresImpl extends JdbcMealRepositoryImpl<LocalDateTime>{
        @Override
    ...
    public static class JdbcMealRepositoryHsqlImpl extends JdbcMealRepositoryImpl<Timestamp>{
        @Override
